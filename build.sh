...
cp Sources/DailySutra/Resources/MenubarDark.png "$BUNDLE/Contents/Resources/MenubarDark.png"
cp Sources/DailySutra/Resources/MenubarLight.png "$BUNDLE/Contents/Resources/MenubarLight.png"
